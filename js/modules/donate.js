var Donate = {
  ...
  onSkuDetails: function(data){
    ...
    for(var i in data.response.details.inAppProducts){
      ...
      $('#donate_table > tbody').append(
        '<tr><td>' + localeData.title + '</td><td>' + localeData.description +'</td><td>' + price.valueMicros / 1000000 + '</td><td><a href="#" class="btn btn-success donate-btn" data-sku="' + product.sku + '">贊助</a></td></tr>'
      );
    }
